...
function get_workdir () { echo "${${PWD:h}:t}/${PWD:t}" | sed 's/[^a-zA-Z0-9/-]/_/g' ; }
...
alias upgradejs='nvm install --lts && nvm install-latest-npm && npm update -g && pnpm self-update && pnpm up -g --latest'
function upgradeall() {
